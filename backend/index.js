...
// 1️⃣ Get all countries for dropdown
...
app.get("/country/:name", function (req, res) {
  const countryName = req.params.name.toLowerCase(); // convert to lowercase

  // Filter the JSON data for the selected country (case-insensitive)
